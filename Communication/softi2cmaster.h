...
#ifndef COMMUNICATION_SOFTI2CMASTER_H_
#define COMMUNICATION_SOFTI2CMASTER_H_
...
public:
	 ...
	 */
	SoftI2cMaster(Gpio& scl, Gpio& sda, Timer& timer);
	void init();
	void deinit();
	void stopWrite();
	void stopRead();
...
private:
	...
	/**
	 * Finishing the acknowledge operation for a write operation.
	 * Is called by \c finishAcknowledge.
	 */
	void finishAcknowledgeWriteOperation();
	/**
	 * Finishing the acknowledge operation for a read operation.
	 * Is called by \c finishAcknowledge.
	 */
...
#endif /* COMMUNICATION_SOFTI2CMASTER_H_ */
