...
{
	m_inputCapture.dataAvailable.connect(this, &FrequencyIn::onDataAvailable);
}

void FrequencyIn::setInputCapture(InputCapture& inputCapture)
{
	m_inputCapture.dataAvailable.disconnect(this, &FrequencyIn::onDataAvailable);
