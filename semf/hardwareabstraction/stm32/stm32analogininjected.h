...
#ifndef SEMF_HARDWAREABSTRACTION_STM32_STM32ANALOGININJECTED_H_
#define SEMF_HARDWAREABSTRACTION_STM32_STM32ANALOGININJECTED_H_
...
public:
	...
	explicit Stm32AnalogInInjected(const Stm32AnalogInInjected& other) = delete;
	virtual ~Stm32AnalogInInjected() = default;
...
#endif
#endif
#endif /* SEMF_HARDWAREABSTRACTION_STM32_STM32ANALOGININJECTED_H_ */
