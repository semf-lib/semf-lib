...
namespace semf
{
SoftPwm::SoftPwm(Gpio& output, app::TimeBase& timebase, bool inverted)
...
void SoftPwm::startOnTime()
{
	...
	m_pwmCycleTimer.timeout.clear();
	m_pwmCycleTimer.timeout.connect(m_startOffTimeSlot);
...
void SoftPwm::startOffTime()
{
	...
	m_pwmCycleTimer.timeout.clear();
	m_pwmCycleTimer.timeout.connect(m_startOnTimeSlot);
