...
#ifndef SEMF_COMMUNICATION_I2CSLAVEHARDWARE_H_
#define SEMF_COMMUNICATION_I2CSLAVEHARDWARE_H_
...
protected:
	 ...
	 * @note In the functions \c write(), \c read() busy is set to \c true. In \c onDataAvailable(), \c onDataWritten()
	...
	/**
	 * @brief Hardware will write data. After finished write operation, \c onDataWritten() function will be called.
	 * @param data Array of data to write.
	 * @param dataSize Size of \c data.
	 */
	virtual void writeHardware(const uint8_t data[], size_t dataSize) = 0;
	/**
	 * @brief Hardware will read data. After finished read operation, \c onDataAvailable() function will be called.
...
#endif  // SEMF_COMMUNICATION_I2CSLAVEHARDWARE_H_
