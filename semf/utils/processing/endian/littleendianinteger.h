...
#ifndef SEMF_UTILS_PROCESSING_ENDIAN_LITTLEENDIANINTEGER_H_
#define SEMF_UTILS_PROCESSING_ENDIAN_LITTLEENDIANINTEGER_H_
...
: m_value{std::endian::big == std::endian::native ? reverse<T>(reinterpret_cast<uint8_t*>(&value), reinterpret_cast<uint8_t*>(&value) + sizeof(T)) : value}
{
}
...
#endif  // SEMF_UTILS_PROCESSING_ENDIAN_LITTLEENDIANINTEGER_H_
