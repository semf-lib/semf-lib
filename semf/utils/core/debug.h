...
#ifndef SEMF_UTILS_CORE_DEBUG_H_
#define SEMF_UTILS_CORE_DEBUG_H_
...
public:
	/**
	 * @brief Adds an object to the list to get printed out for debug.
...
#endif /* SEMF_UTILS_CORE_DEBUG_H_ */
