...
#ifndef PROCESSING_ENDIAN_BIGENDIANINTEGER_H_
#define PROCESSING_ENDIAN_BIGENDIANINTEGER_H_
...
public:
	...
	BigEndianInteger<T>& operator*=(T i);
	/**
	 * @brief Increments \c this (prefix) and returs a reference to \c this.
	 * @return Reference to \c this.
	 */
	 ...
	 */
	BigEndianInteger<T>& operator++(int);
	/**
...
#endif  // PROCESSING_ENDIAN_BIGENDIANINTEGER_H_
