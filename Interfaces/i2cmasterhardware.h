...
#ifndef INTERFACES_I2CMASTERHARDWARE_H_
#define INTERFACES_I2CMASTERHARDWARE_H_
...
public:
	...
	/**
	 * @brief Checks if the given address is available on the bus. Emits \c address found if successful (ACK). \c error signal will be emitted, if no slave answers (NACK).
...
#endif  /* INTERFACES_I2CMASTERHARDWARE_H_ */
