...
#ifndef INTERFACES_AESCBC_H_
#define INTERFACES_AESCBC_H_
...
public:
    ...
    /**
     * @brief Resets the initialization vector.
     */
     ...
     * \note The content of the initialization vector is updated so that you can
