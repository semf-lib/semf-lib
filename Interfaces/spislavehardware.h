...
#ifndef INTERFACES_SPISLAVEHARDWARE_H_
#define INTERFACES_SPISLAVEHARDWARE_H_
...
protected:
	...
	/**
	 * @brief Data available routine, emits the \c dataAvailable signal.
	 */
	void onDataAvailable();
	/**
	 * @brief Data written routine, emits the \c dataWritten signal.
	 */
	void onDataWritten();
	/**
	...
	/**
	 * @brief Stops the hardware to read.
	 */
	virtual void stopReadHardware() = 0;
	/**
	 * @brief Stop the hardware to write.
	 */
...
#endif /* INTERFACES_SPISLAVEHARDWARE_H_ */
