...
#ifndef INTERFACES_CAN_H_
#define INTERFACES_CAN_H_
...
public:
	...
	/**
	 * @brief Sends a CAN request. Message id has to be set first by calling \c setMessageId().
	 */
