...
#ifndef HARDWAREABSTRACTION_STM32_STM32UART_H_
#define HARDWAREABSTRACTION_STM32_STM32UART_H_
...
{
/**
 * @brief   Implementation of the UART interface for an STM32F uC.
 */
...
#endif /* HARDWAREABSTRACTION_STM32_STM32UART_H_ */
