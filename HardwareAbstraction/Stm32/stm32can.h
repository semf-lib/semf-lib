...
#ifndef HARDWAREABSTRACTION_STM32_STM32CAN_H_
#define HARDWAREABSTRACTION_STM32_STM32CAN_H_
...
public:
	 ...
	 */
	void deinit();
	void setReadBuffer(uint8_t buffer[], size_t bufferSize);
	void stopWrite();
	void stopRead();
	/**
	 ...
	 */
	void setFilter(uint32_t filterBank, uint32_t messageId, uint32_t messageIdMask);
...
private:
	...
	/** Internal buffer for request (STM HAL Workarrount).*/
...
#endif /* HARDWAREABSTRACTION_STM32_STM32CAN_H_ */
