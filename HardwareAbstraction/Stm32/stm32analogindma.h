...
#ifndef HARDWAREABSTRACTION_STM32_STM32ANALOGINDMA_H_
#define HARDWAREABSTRACTION_STM32_STM32ANALOGINDMA_H_
...
#include <Interfaces/analogindma.h>
namespace semf
{
...
public:
	 ...
	 */
	void start(uint8_t buffer[], size_t bufferSize);
	/**
...
#endif /* HARDWAREABSTRACTION_STM32_STM32ANALOGINDMA_H_ */
